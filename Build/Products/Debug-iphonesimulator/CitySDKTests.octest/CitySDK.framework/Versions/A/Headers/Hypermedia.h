...
@interface Hypermedia : NSObject 
@property (nonatomic, copy) NSString *href; /**< \brief the URL for the given hypermedia */
@property (nonatomic) bool templated; /**< \brief indicates whether the href follows the URI template or not */
@end
