...
@interface Relationship : POITermType
@property (nonatomic, copy) NSString *targetPOI; /**< targets a POI id */
@property (nonatomic, copy) NSString *targetEvent; /**< targets an event id */
@end
