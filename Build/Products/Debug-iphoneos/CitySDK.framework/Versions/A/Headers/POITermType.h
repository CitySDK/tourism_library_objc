...
@interface POITermType : POIBaseType
@property (nonatomic, copy) NSString *term; /**< a machine-readable character string to designate any number of discrete choices */
@property (nonatomic, copy) NSString *scheme; /**< an absolute reference to the schema enumerating the discrete choices in term */
@end
