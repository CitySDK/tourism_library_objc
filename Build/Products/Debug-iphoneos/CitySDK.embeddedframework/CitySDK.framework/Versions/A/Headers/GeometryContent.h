...
/**
 * \brief A simple protocol to represent points, lines or polygons.
 *
 * @author Pedro Cruz
 *
 */
@protocol GeometryContent <NSObject>
/**
 * \brief Gets the number of geometries of the object which implements this protocol
 * @return the number of geometries of a given object
 */
- (int) getNumGeo;
@end
