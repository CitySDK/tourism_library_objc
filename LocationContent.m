 ...
 * Copyright 2013, IST
 */
#import "LocationContent.h"

/**
 * \brief Container of a location.
 *
 * @author Pedro Cruz
 *
 */
@implementation LocationContent
/**
 * \brief Initializes with a given latitude and longitude
...
{
    return [NSString stringWithFormat:@"%@; %@", [self.latitude description], [self.longitude description]];
}
