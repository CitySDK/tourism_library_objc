...
@interface HypermediaLink : NSObject
@property (nonatomic, copy) NSString *version; /**< \brief the version of this hypermedia link */
@property (nonatomic, retain) NSMutableDictionary *links; /**< \brief the existing hypermedia links */
