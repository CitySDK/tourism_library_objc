...
/**
 * \brief Container of a single Point.
 *
 * @author Pedro Cruz
 *
 */
@implementation PointContent
/**
 * \brief Initializes this point with a given latitude and longitude
 * @param latitude latitude coordinates
 * @param longitude longitude coordinates
 */
-(id) initPointWithLatitude: (NSString *)latitude andLongitude: (NSString *)longitude
{
    self = [super init];
    if(self) {
        self.location = [[LocationContent alloc] initWithLatitude:latitude andLongitude:longitude];
    }
